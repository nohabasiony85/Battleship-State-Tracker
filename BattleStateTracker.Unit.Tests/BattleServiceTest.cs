...
namespace BattleStateTracker.Unit.Tests
{
    public class BattleServiceTest
    {
        ...
        {
            var logger = new Mock<ILogger<BattleService>>();
            
            _battleService = new BattleService(logger.Object);
        }
        ...
        [Fact] 
        public void ShouldAddShip_Throw_Exception_When_Given_No_Of_Ships_Exceeded()
        {  
            //Arrange
